...
{
    class WordParserRusFull : IModule
    {
        public WordParserRusFull()
        { }
        ...
        public string Name()
        { return "Парсер слов (Rus, Full)"; }
        public string Tip()
        { return "Парсит слова из русского текста в одном экземпляре, первую букву делает заглавной, учитываются все слова."; }
    }
}
