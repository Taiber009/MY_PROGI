...
namespace MultiTextTools.Classes
{
    class WordParser : IModule
    {
        ...
        public string Name()
        { return "Парсер слов (Eng, >=5)"; }
        public string Tip()
        { return "Парсит слова из английского текста в одном экземпляре, первую букву делает заглавной, слова с менее 5 букв не учитываются."; }
    }
}
