...
namespace Render
{
    public static class VectorOperations
    {
        ...
        public static Structures.MyPoint VectorMultiply(Structures.MyPoint Vector, Matrices.Matrix Matrix)
        {
            ...
            Structures.MyPoint P = new Structures.MyPoint(Out[0], Out[1], Out[2]);
            double[] TempVector = VectorMultiply(new double[] { Vector.Vector[0], Vector.Vector[1], Vector.Vector[2], 1 }, Matrix);
            P.Vector = new double[] { TempVector[0], TempVector[1], TempVector[2] };
            return P;
        }
        ...
        public static double VectorGetLength(Structures.MyPoint Arr)
        {
      ...
      B[2] - A[1]});
        ...
        public static Structures.MyPoint Normalize(Structures.MyPoint Input)
        {
            double Length = 1;
            Length = VectorGetLength(Input);
            if (Length == 0)
                return new Structures.MyPoint(0, 0, 0);
            else
                return new Structures.MyPoint(Input.x / Length, Input.y / Length, Input.z / Length);
        }
        ...
        public static double[] VectorLinearSum(double[] A, double[] B)
        {
            return Normalize(new double[] { A[0] + B[0], A[1] + B[1], A[2] + B[2] });
        }
        public static double[] VectorLinearAvg(double[] A, double[] B, double[] C)
        {
        ...
        public static double[] VectorLinearAvg(double[] A, double[] B, double[] C, double[] D)
        {
            return Normalize(new double[]
            {
        (A[0] + B[0] + C[0] + D[0]) / 4,
